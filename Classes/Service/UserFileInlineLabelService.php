<?php
namespace LEF\LefResponsiveImages\Service;
            ...
            if (!empty($addition)) {
                if (is_array($addition)) {
                    ...
                    foreach ($addition as $k => $field) {
                        $adds .= LocalizationUtility::translate('LLL:EXT:lef_responsive_images/Resources/Private/Language/Backend.xlf:field.breakpoints.' . trim($field), 'lang') . ' ';
                    }
                    $addition = $adds;
                } else {
                    $addition = LocalizationUtility::translate('LLL:EXT:lef_responsive_images/Resources/Private/Language/Backend.xlf:field.breakpoints.' . trim($addition), 'lang');
                }
